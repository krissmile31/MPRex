package com.example.myui.account.notes;
...
import com.example.myui.account.notes.adapters.NoteAdapter;
import com.example.myui.account.notes.db.NoteManager;
import com.example.myui.account.notes.models.Note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NoteActivity.this, Account.class));
            }
        });
