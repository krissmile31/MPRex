...
public class FriendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friends.add(new Friend("Thanh Nga", "jeongah", "0112jeongah", "profile.php?id=100010076803151","1801040157@s.hanu.edu.vn", "0354676878"));
        friends.add(new Friend("Minh Phượng", "aya", "chigaixinh","lethiminhphuongggg","1801040171@s.hanu.edu.vn", "0657687299"));
        friends.add(new Friend("Thu Trang", "chan", "t_trang217","bot.bien","1801040226@s.hanu.edu.vn", "0213455467"));
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FriendActivity.this, Favourite.class));
            }
        });
